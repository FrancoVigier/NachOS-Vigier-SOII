...
public:
    ...
    void Signal();
    void Broadcast();
    int SleepingThreadAmount();
private:

    const char *name;
    List <Semaphore *> *colaProcesosDormidos;  //A list in representation of all process who try to get a Mutex Lock
    int cantidadDormidos;
    Lock* lock; //Mutex Lock, a key for the valhalla
