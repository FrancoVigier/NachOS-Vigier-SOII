...
static const Test TESTS[] = {
    ...
    { &ThreadTestGardenNew,   "garden semaphore",   "Ornamental garden with semaphores" },
    { &ThreadTestGardenMutex,   "garden mutex",   "Ornamental garden with Mutex/Lock" },
    { &ThreadTestGardenJoin,   "garden semaphore with Join",   "Ornamental garden with semaphores and Join" },
    { &ThreadTestProdCons, "prodcons", "Producer/Consumer" },
    { &ThreadTestProdConsPriorities, "prodcons priorities", "Producer/Consumer with priorities" },
    { &ThreadTestMutlithreadJoin, "multithread join", "Multiple threads wait for one" },
};
