...
public:
    ...
    unsigned long numPageHit;
    /// Number of pages send from tlb to swap
    unsigned long numPageToSwap;
    /// Number of pages send from swap to frame table
    unsigned long numPagetoTLB;
    ///***
